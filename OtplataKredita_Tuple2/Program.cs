(double anuitet, double iznosKamata) IzracunParametara(double iznos, double stopa, int brojGodina)
{
...
do
{
    ...
    else
    {
        ...
        try
        {
            ...
            Console.WriteLine("Za zadani iznos kredita {0:N2}, godišnju kamatnu stopu {1} i broj godina otplate {2} anuitet je {3:N2} a ukupno plaćena kamata {4:N2}", glavnica, stopa, brojGodina, rezultat.anuitet, rezultat.iznosKamata);
        }
        catch (Exception ex)
        {
